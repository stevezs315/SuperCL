...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", help="folder where the extracted training data is", type=str, default="/mnt/nas/ZengShuang/ACDC_datasets/segmentation/training/training/")
    parser.add_argument("-out_labeled", help="folder where to save the data for the 2d network", type=str,
                        default="/mnt/nas/ZengShuang/a1-positional_cl-main/positional_cl-main/dataset/acdc/out_labeled/")
    # V:\ZengShuang\a1-positional_cl-main\positional_cl-main\dataset\acdc
    parser.add_argument("-out_unlabeled", help="folder where to save the data for the 2d network", type=str,
                        default="/mnt/nas/ZengShuang/a1-positional_cl-main/positional_cl-main/dataset/acdc/out_unlabeled/")
