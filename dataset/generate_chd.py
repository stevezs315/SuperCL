...
if __name__ == "__main__":
    ...
    parser.add_argument("-indir", help="folder where the extracted training data is", type=str, default="/mnt/nas/ZengShuang/CHD_dataset/CHD_segmentation_dataset/")
    parser.add_argument("-labeled_outdir", help="folder where to save the data for the 2d network", type=str, default="/mnt/nas/ZengShuang/a1-positional_cl-main/positional_cl-main/dataset/chd/out_labeled/")
    parser.add_argument("-unlabeled_outdir", help="folder where to save the data for the 2d network", type=str, default="/mnt/nas/ZengShuang/a1-positional_cl-main/positional_cl-main/dataset/chd/out_unlabeled/")
